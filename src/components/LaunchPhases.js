  ...
  return (
    <section className="relative overflow-hidden bg-white py-10 md:py-16 lg:py-20">
      ...
      <motion.div
        ...
        {/* Heading */}
        <motion.div variants={fadeUp} className="max-w-xl mb-12 lg:mb-14">
        ...
        <div className="relative">
          ...
          <motion.div variants={fadeUp} className="hidden lg:block absolute top-6 left-24 right-24 h-[2px] bg-gray-200" />
